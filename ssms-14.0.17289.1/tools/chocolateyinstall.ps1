...
$packageName= 'SQL Server Management Studio 17.9.1'
...
$ssms170 = $false # Get-ItemProperty HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\* | Select-Object DisplayName, DisplayVersion | Where-Object { $_.DisplayName -eq "SQL Server Management Studio" -and ([Version]$_.DisplayVersion) -ge $version17 }
...
$packageArgs = @{
  ...
  softwareName  = "SQL Server Management Studio 17.9.1"
  checksum      = ''
  checksumType  = 'SHA256'
}
